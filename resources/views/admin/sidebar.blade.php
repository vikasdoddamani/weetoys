<div class="d-flex align-items-stretch">
    ...
    <nav id="sidebar">
      ...
      <div class="sidebar-header d-flex align-items-center">
        ...
        <div class="title">
          <h1 class="h5">Vikas Doddamani</h1>
          <p>Web Designer</p>
        </div>
      </div>
      ...
      <ul class="list-unstyled">
              ...
              <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-windows"></i>Product's </a>
              ...
              <li><a href="{{url('view_orders')}}"> <i class="icon-grid"></i>Order's </a></li>
      </ul>
    </nav>
